...
module.exports = {
  ...
  credit_engine: {
    ...
    'system_of_record_associated_data scoring_calculation': getCalculationDatalist(
      {
        multi: false,
        enginetype:'scoring',
      }
    ...
    'system_of_record_associated_data pricing_calculation': getCalculationDatalist(
      {
        multi: false,
        enginetype:'pricing',
      }
    ),
    'system_of_record_associated_data pricing_segments': getDatalist({
      multi: true,
      fieldname: 'pricing_segments',
      fieldnamepreview:'segments',
      entity:'segment',
      resourceurl:'segments',
    }),
    'system_of_record_associated_data scoring_segments': getDatalist({
      multi: true,
      fieldname: 'scoring_segments',
      fieldnamepreview:'segments',
      entity:'segment',
      resourceurl:'segments',
    }),
